...
describe "spree/rate_hotels/new" do
  before(:each) do
    assign(:spree_rate_hotel, stub_model(Spree::RateHotel,
      :product_id => 1,
      :room_id => 1,
      :plan_id => 1,
      :adults_one => 1.5,
  ...
  it "renders new spree_rate_hotel form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", spree_rate_hotels_path, "post" do
